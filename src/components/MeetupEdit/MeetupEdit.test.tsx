...
describe("MeetUpCard", () => {
    ...
    it("organiser edits meetup on click", () => {
      ...
      editInputs.at(4).simulate('change', { target: { value: '24 februari' } } )
      editInputs.at(5).simulate('change', { target: { value: '18:00' } } )
      editInputs.at(6).simulate('change', { target: { value: 2 } } )
      editButton.simulate('click')
      const listItem = wrapper.find('.meetupList .meetupListItem h4').at(0)
      expect(listItem.text()).toBe("Gratis grillkorv")
    })
